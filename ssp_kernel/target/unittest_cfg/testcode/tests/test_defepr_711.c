...
test_main(void)
{
	...
	CU_ASSERT_EQUAL(tinib_epriority[2], INT_PRIORITY(2));
	CU_ASSERT_EQUAL(tinib_epriority[3], INT_PRIORITY(2));
	CU_ASSERT_EQUAL(tinib_epriority[4], INT_PRIORITY(2));
	CU_ASSERT_EQUAL(tinib_epriority[5], INT_PRIORITY(2));
	CU_ASSERT_EQUAL(tinib_epriority[6], INT_PRIORITY(2));
