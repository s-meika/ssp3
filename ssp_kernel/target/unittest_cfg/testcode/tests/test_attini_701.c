...
test_main(void)
{
	...
	/* post condition */
	CU_ASSERT_EQUAL(test_bitmap_inirtn, UINT16_C(0x007f));
}

void inirtn_1(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_1");   // 到達の確認
...
void inirtn_2(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_2");   // 到達の確認
...
void inirtn_3(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_3");   // 到達の確認
...
void inirtn_4(intptr_t exinf) {
	CU_PASS("test_attini_701: initrtn_4");   // 到達の確認
...
void inirtn_5(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_5");   // 到達の確認
...
void inirtn_6(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_6");   // 到達の確認
...
void inirtn_7(intptr_t exinf) {
	CU_PASS("test_attini_701: inirtn_7");   // 到達の確認
