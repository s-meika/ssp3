...
test_main(void)
{
	...
	CU_ASSERT_EQUAL(tinib_epriority[3], INT_PRIORITY(3));
	CU_ASSERT_EQUAL(tinib_epriority[4], INT_PRIORITY(3));
	CU_ASSERT_EQUAL(tinib_epriority[5], INT_PRIORITY(3));
	CU_ASSERT_EQUAL(tinib_epriority[6], INT_PRIORITY(3));
