 ...
 *  データキュー初期化ブロック
 */
extern const ATR dtqinib_atr[];			/* データキュー属性 */
extern intptr_t* const dtqinib_data[];	/* データ格納領域の先頭番地 */
extern const uint8_t dtqinib_size[];	/* データキューの容量 */

/*
 *  データキュー管理ブロック
 */
extern uint8_t dtqcb_count[];				/* データキューに格納されているデータの数 */
extern uint8_t dtqcb_head[];				/* 最初のデータの格納場所 */
extern uint8_t dtqcb_tail[];				/* 最後のデータの格納場所の次 */
