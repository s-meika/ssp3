...
#define TNUM_LOGPAR	6

typedef struct {
	uint_t		logtype;				/* ログ情報の種別 */
	SYSTIM		logtim;					/* ログ時刻 */
	intptr_t	logpar[TNUM_LOGPAR];	/* その他のログ情報 */
} SYSLOG;
